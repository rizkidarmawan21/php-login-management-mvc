        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/users/register">
                <div class="form-floating mb-3">
                    <input name="id" type="text" class="form-control" value="<?= $_POST['id'] ?? '' ?>" id="id" placeholder="id">
                    <label for="id">Id</label>
                </div>
                <div class="form-floating mb-3">
                    <input name="name" type="text" class="form-control" value="<?= $_POST['name'] ?? '' ?>" id="name" placeholder="name">
